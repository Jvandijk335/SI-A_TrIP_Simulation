...
SetAtt([nrrecords], 50);
SetAtt([randomnr], 5.34496766427619);
SetAtt([flag], 1);
SetAtt([value], 3);
...
CreateTableColumn(1, 64, [`Cumulative%`
2
4
6
8
...
SetExprAtt([ExitTrigger], [0]);
SetExprAtt([QueueDiscipline], [4DS[{.findqueuepos([~1],2)|4. Sort by Label Ascending: The atoms with the lowest value of the label named ~NrGroceries~ are put in front.}findqueuepos([NrGroceries],2)]4DS]);
SetAtt([DrawLoc], 1);
