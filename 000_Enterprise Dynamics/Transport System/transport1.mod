...
SetExprAtt([CycleTime], [Uniform(9.5, 10.5)]);
...
SetExprAtt([CreationTrigger], [{.0|10. Do Nothing.}0]);
SetExprAtt([ExitTrigger], [0]);
SetExprAtt([FirstProduct], [Uniform(9.5, 10.5)]);
SetExprAtt([MaxProducts], [{.-1|1. Unlimited.}-1]);
SetAtt([Icon3D], 4);
SetAtomSettings([], 7168771, 176);
Set(Icon(a), 
...
SetExprAtt([Speed], [1]);
SetExprAtt([TravelTimeC], [Length / Speed]);
SetAtt([TempMaxLoc], -0.0343605621856113);
SetExprAtt([CurLoc], [Min(TempMaxLoc, Speed * (Time - EntryTime(cs)))]);
SetAtt([ExitTime], 0);
SetAtt([CurContent], 0);
SetExprAtt([Length], [If(Elevation <> 0,   Hor_Length / Cos(Angle), Hor_Length)]);
...
SetExprAtt([Speed], [1]);
SetExprAtt([TravelTimeC], [Length / Speed]);
SetAtt([TempMaxLoc], 0.465639437814389);
SetExprAtt([CurLoc], [Min(TempMaxLoc, Speed * (Time - EntryTime(cs)))]);
SetAtt([ExitTime], 0);
SetAtt([CurContent], 0);
SetExprAtt([Length], [If(Elevation <> 0,   Hor_Length / Cos(Angle), Hor_Length)]);
...
LoadEvent(10.5062149199905, 6, 1, 0, 0, 0);
LoadEvent(9.97161191383947, 7, 1, 0, 0, 0);
LoadEvent(7.81191803859508, 8, 1, 0, 0, 0);
LoadEvent(10.9221971883932, 9, 1, 0, 0, 0);
LoadEvent(7.5466499253975, 10, 1, 0, 0, 0);
